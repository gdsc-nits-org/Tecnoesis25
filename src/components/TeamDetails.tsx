...
const TeamDetails: React.FC = () => {
    ...
    <>
      ...
      {isLap && (
        <section className="absolute w-full min-h-screen bg-black text-white flex flex-col items-center justify-center overflow-hidden">
            ...
            >
              {/* 🖼️ Shadow Overlay (bg4) */}
              <div
                className="absolute inset-0 bg-[url('/TeamDetails/bg4.png')] bg-no-repeat bg-center pointer-events-none z-60"
                style={{
              ...
              {/* 🌌 Strong vignette covering top & bottom too */}
              <div
            ...
            {/* 🖼️ Fullscreen Background (bg3 with radial mask) */}
            <div
              className="absolute inset-0 w-full h-[150vh]  -top-[30vh] left-[28vw] right-[5vw] overflow-hidden z-20"
              // style={{
              //   WebkitMaskImage:
            ...
            >
              ...
              {/* Optional: edge shading for depth */}
              <div
                className="absolute inset-0 pointer-events-none"
                style={{
                  background:
                    'radial-gradient(circle, rgba(0,0,0,0) 70%, rgba(0,0,0,0.4) 100%)',
                  mixBlendMode: 'multiply',
                }}
              />
            </div>
            ...
            <div className="absolute top-[16vh] text-center  z-50 flex flex-col items-center gap-[0.3vh]">
              ...
              <div className="flex  items-center ">
                <div className="flex items-end text-[8vw] md:text-[2.2vw] font-squarish uppercase font-large tracking-[0.07em]">
                ...
                <div className="text-[#FF3B2E] text-[8vw] md:text-[3vw] font-squarish  font-large relative top-[1.1vh] tracking-[0.1em] uppercase">
                  {team.name}
                </div>
              </div>
            </div>
            ...
            {/* 🔲 Solid black with weak reddish tint */}
              ...
              <div className="relative w-full h-[50vh] flex flex-col justify-between gap-[1.5vh] p-[1.5vh] pt-[3vh] pr-[3vh] z-10">
                {team.members.map((member, i) => (
                  <div key={i} className="relative flex items-center gap-[2vw] flex-1 min-h-0">
                    ...
                    {/* 🔴 Left: Avatar Circle with Futuristic Glow */}
                    ...
                    {/* 🟥 Right: Futuristic Name Box (External SVG Background) */}
                    <div className="relative w-[30vw] aspect-[6/1.5] flex items-center justify-between text-white ">
                      ...
                      {/* <div className="absolute z-10 flex  gap-[6vw]  items-center w-full pr-[2vw] pl-[3vw]">
                        <div>
                          <p className="text-[0.7vw] font-squarish font-large uppercase leading-none whitespace-nowrap">
                            {member.name}
                          </p>
                          <p className="text-[0.6vw] text-[#38bdf8] font-squarish uppercase mt-[0.3vh] whitespace-nowrap ">
                            {member.tag}
                          </p>
                        </div>
                        ...
                        {member.leader && (
                        <Image
                          src="/teamDetails/leader.svg" // ← replace with your actual image path
                          alt="Leader Badge"
                          width={50}
                          height={50}
                          className="w-[3vw] h-auto" // adjust width/height to match design
                        />
                      )}
                    </div>
                  </div> */}
  ...
  <div className="flex-1 min-w-0">
    <p className="text-[0.7vw] font-squarish font-large uppercase leading-none truncate">
      {member.name}
    </p>
    <p className="text-[0.6vw] text-[#38bdf8] font-squarish uppercase mt-[0.3vh] truncate">
      {member.tag}
    </p>
  </div>
  ...
  {member.leader && (
    <div className="flex-shrink-0 ml-4">
      ...
      />
          ...
          {/* Register Image */}
          <Image
            src="/teamDetails/proceed.svg"   // ← replace with your Register button image
            alt="Register"
            width={50}
            height={50}
          ...
          {/* Edit Details Image */}
          <Image
            src="/teamDetails/edit.svg"       // ← replace with your Edit button image
            alt="Edit Details"
            width={50}
            height={50}
            className="w-[15vw] h-auto brightness-125 "
      ...
      {isIpad && (
        <section className="relative w-full min-h-screen bg-black text-white flex flex-col items-center justify-start overflow-hidden px-[5vw] py-[10vh]">
          {/* Full Background */}
          <div className="absolute inset-0 bg-[url('/TeamDetails/gridmobile.svg')] brightness-50 bg-cover bg-center"
          style={{
          ...
          {/* Title */}
            <div className="absolute top-[4vh] text-center  z-20 flex flex-col items-center gap-[0.2vh] brightness-75">
              ...
              <div className="absolute top-[10vh] flex  items-center ">
                <div className="flex items-baseline  font-squarish uppercase font-large  leading-none">
                {/* Bigger first letters */}
                  <span className="text-[6vw]  align-baseline leading-[1]">T</span><span className="relative text-[5vw] top-[0.1vh]">eam&nbsp;</span>
                  <span className="text-[6vw]  align-baseline leading-[1]">N</span> <span className="relative text-[5vw] top-[0.1vh] whitespace-nowrap">ame : &nbsp;</span>
                </div>
                <div className="text-[#FF3B2E] text-[7vw]  font-squarish  font-medium relative top-[0.2vh]  uppercase">
                  {team.name}
                </div>
              </div>
            </div>
          ...
          <div className="absolute top-[20vh] flex flex-col gap-[2vh] mt-[5vh] w-[90vw] z-10 border border-black rounded-2xl">
            {/* 🔲 Background Image with Subtle Red Tint Overlay */}
            <div className="absolute  -left-[3vw] w-[95vw] h-[60vh] inset-0 z-30 overflow-hidden bg-black border border-black rounded-2xl"> 
              <div className="w-full h-full rounded-2xl overflow-hidden">
                <Image src="/teamDetails/blackbox.svg" alt="Full Background" 
                fill 
                priority 
                  ...
                  <div key={i} className="relative flex items-center gap-[8vw] brightness-125">
                    ...
                    <div
                      ...
                      style={{
                        ...
                        backgroundSize: '100% 100%', // makes sure full SVG fills div
                      }}
                    >

                      {/* Text Content Inside Frame */}
                      <div className="absolute z-10 flex gap-[27vw] items-center w-full pr-[2vw] pl-[8vw]">
                        <div>
                          <p className="text-[2vw] font-squarish font-large uppercase leading-none whitespace-nowrap">
                            {member.name}
                          </p>
                          <p className="text-[1.5vw] text-[#38bdf8] font-squarish uppercase mt-[0.3vh] whitespace-nowrap ">
                            {member.tag}
                          </p>
                        </div>
                        ...
                        <Image
                          ...
                          width={50}
                          height={50}
                          className="w-[8vw] h-auto" // adjust width/height to match design
                        />
                      )}
                    </div>
                  </div>
      ...
      {isPhone && (
        <section className="relative w-full min-h-screen bg-black text-white flex flex-col items-center justify-start overflow-hidden px-[5vw] py-[10vh]">
          {/* Full Background */}
          <div className="absolute inset-0 bg-[url('/TeamDetails/gridmobile.svg')] brightness-50 "
          style={{
