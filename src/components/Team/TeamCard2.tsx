...
const Card2 = () => {
    return(
        <div className="relative w-[320px] h-[400px] z-0">
            ...
            {/* Bottom left corner */}
            <div className="flex flex-row absolute bottom-0 left-0 z-1 text-[#ffffff]" style={{
                minWidth:'250px',
                width:'250px',
                minHeight:'250px',
                height:'250px',
                ...
                <div className="flex flex-row p-5 font-nyxerin">
                    ...
                    <div className="absolute top-[60px] left-[20px]" style={{ transform: 'rotate(-90deg)' }}>
                        <div className="flex flex-row items-center gap-3">
                            <a href="#" aria-label="Instagram" className="text-[#ff0000] hover:opacity-80">
                                {/* Instagram */}
                            ...
                            <a href="#" aria-label="Facebook" className="text-[#ff0000] hover:opacity-80">
                                {/* Facebook */}
                            ...
                            <a href="#" aria-label="LinkedIn" className="text-[#ff0000] hover:opacity-80">
                                {/* LinkedIn */}
