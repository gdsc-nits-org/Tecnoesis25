                ...
                <div className="flex flex-row p-5 font-nyxerin">
                    ...
                    <div className="absolute top-[60px] left-[20px]" style={{ transform: 'rotate(-90deg)' }}>
                        <div className="flex flex-row items-center gap-3 socialBar">
                            <a href={insta} aria-label="Instagram" className="text-white hover:opacity-80">
                            ...
                            <a href={facebook} aria-label="Facebook" className="text-white hover:opacity-80">
                            ...
                            <a href={linkedin} aria-label="LinkedIn" className="text-white hover:opacity-80">
