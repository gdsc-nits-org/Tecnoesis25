      ...
      <style jsx>{`
        ...
        .glitch-overlay-effect {
          ...
          filter: saturate(1.5) hue-rotate(15deg)
            drop-shadow(1px 0 0 rgba(255, 0, 0, 0.5)) blur(0.5px);
        }
        ...
        .glitch-bar-mask {
          ...
          mask-image: repeating-linear-gradient(
            to right,
            /* Opaque part (the bar) is 1vw wide */ #000 0,
            #000 1.5vw,
            /* Transparent part (the space) is 1vw wide */ transparent 1.5vw,
            transparent 3vw
          );
