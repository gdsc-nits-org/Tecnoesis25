...
const SectionSkeleton = ({ height = "h-screen" }: { height?: string }) => (
  <div
    className={`${height} w-full animate-pulse bg-gradient-to-b from-gray-900 to-black`}
  >
...
const AboutSection = dynamic(
  () =>
    import("../../../components/robotron").then((mod) => ({
