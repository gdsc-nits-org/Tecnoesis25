...
const EventCard: React.FC<EventCardProps> = ({ event, position }) => (
  <div
    className={`small-bounce absolute w-[40%] transition-transform duration-1000 ${position === "top-left" ? "left-[8%] top-[10%]" : "bottom-[10%] right-[8%]"}`}
  >
...
const MobileEventCard: React.FC<MobileEventCardProps> = ({ event }) => (
  <div className="relative w-[70vw] max-w-sm flex-shrink-0 p-4">
    <div className="relative aspect-[3/4] rounded-xl border-2 border-orange-500/50 bg-black/30 p-4">
      <Image
        src={event.imageUrl}
        alt={event.name}
        layout="fill"
